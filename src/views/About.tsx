...
export default function About() {
    return (
        <div className="container">
            ...
            <p className="text">
                Buenas! Soy Manuel, tengo 24 años y soy estudiante de ingeniería en informática.
                <br />
                <br />
                ...
                Si te interesa, podés contactarme por cualquiera de los medios que aparecen en la sección de contacto.
            </p>
        </div>
    )
}
